...
public class Ordenamiento {
    ...
    // creamos una matriz de 4 filas y 3 columnas (de tipo global por eso ), para este ejemplo se llena la matriz desde su creacion
        static String[][] matriz = {{"Honda ","Civic  ","5"},{"Toyota","Corolla","19"},{"Mazda ", "CX-3   ", "40"},{"BMW   ","X1     ","20"}};
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            int porDos= parseInt(numeroS)*2;
            System.out.println("El numero es: "+numeroS);
            System.out.println("Multiplicacion igual a: "+porDos);
        }catch(java.lang.NumberFormatException error){
            System.out.println("No a ingresado un numero...!" + error);
        }
